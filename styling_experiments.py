# -*- coding: utf-8 -*-
"""styling_experiments.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1cOA5IuB-4sUrq77d1lEpxJi6FvebnV5J
...
import cv2,PIL.Image,urllib,zipfile
...
get_img('pattern09.png')
get_img('picture09.png')
get_img('pattern04.jpeg')
get_img('pattern05.jpeg')
get_img('pattern06.jpeg')
get_img('pattern10.png')

@register_line_magic
def hm_run(pars):
    pars=pars.split()
    content_image=load_img('pattern'+pars[0]+'.png')
    style_image=load_img('pattern'+pars[1]+'.jpeg')
...
picture01=cv2.imread('pattern10.png')
pattern01=cv2.imread('picture09.png')
picture01=cv2.resize(picture01,(400,400))
pattern01=cv2.resize(pattern01,(400,400))
...
picture01=cv2.imread('pattern10.png')
pattern01=cv2.imread('pattern09.png')
